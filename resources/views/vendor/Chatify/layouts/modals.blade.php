            ...
            <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data"
                ...
                <div class="app-modal-body">
                    ...
                    <div class="avatar av-l upload-avatar-preview chatify-d-flex"
                        style="background-image: url('{{ auth()->user()->avatar ? asset('storage/avatar/' . auth()->user()->avatar) : 'https://ui-avatars.com/api/?background=random&name=' . urlencode(auth()->user()->first_name . ' ' . auth()->user()->last_name) }}');">
                    </div>
